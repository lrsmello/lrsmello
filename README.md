...
|--------|-------------|--------------|
| [**London Affordable Place to Live**]([https://github.com/seuusuario/genai-assistant](https://github.com/lrsmello/AFFORDABLE_HOME_LONDON)) | Recommendation system for London rentals based on lifestyle, values and quality of life. | Gaussian AHP, Python, Flask, Docker |
